TK:dialog {
  ...
  : edit_box { label="村名"; edit_width =10; value="高老庄";key="kname";}
  : edit_box { label="总图"; edit_width =10; value="1";key="kzt";}
  : edit_box { label="平面"; edit_width =10; value="2";key="kpm"; }
  : edit_box { label="纵断"; edit_width =10; value="2";key="kzd";}
  : edit_box { label="材料"; edit_width =10; value="1";key="kcl";}
  : edit_box { label="横断"; edit_width =10; value="1";key="khd";}
